...
const ProductCard = ({ product, index }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -10 }}
      className="group bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all duration-300 h-full flex flex-col"
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        <div className={`inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-br ${product.gradient} mb-4`}>
        ...
        <div
          className="inline-flex items-center text-blue-400 hover:text-blue-300 font-medium transition-colors group/btn mt-auto"
        >
          View Details
